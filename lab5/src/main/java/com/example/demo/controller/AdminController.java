...
public class AdminController {
    ...
    public String saveResult(@PathVariable Long id, @RequestParam Integer homeScore, @RequestParam Integer awayScore) {
        gameService.updateResult(id, homeScore, awayScore);
        return "redirect:/admin/games";
    }
}